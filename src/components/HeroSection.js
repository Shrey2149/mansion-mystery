    ...
    <>
      <style jsx>{`
        * {
        ...
        .nav-bg {
          background: rgba(20, 20, 20, 0.65); /* Softer, more transparent */
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 nav-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-14 sm:h-16 md:h-18">
            <div className="flex-shrink-0 navbar-instagram">
              {/* Instagram Link */}
              <a
                href="https://www.instagram.com/mysterymansion.in?igsh=aXZhenZydmFoYjR4"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Instagram"
                className="inline-flex items-center"
                style={{ color: '#E8E3E3', textDecoration: 'none' }}
              >
                ...
                <span style={{ fontFamily: 'Avenir', fontWeight: 600 }}>Instagram</span>
              </a>
