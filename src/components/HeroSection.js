  ...
  const faqData = [
    {
      ...
      answer: "Currently, we have Mystery Mansions in Gurugram and Greater Noida. More locations are launching soon."
    },
    {
  ...
  return (
    <>
      <style>{`
        ...
        .wavy-letter:nth-child(34) { animation-delay: 3.4s; }
        .wavy-letter:nth-child(34) { animation-delay: 3.5s; }
        .wavy-letter:nth-child(34) { animation-delay: 3.6s; }
        .wavy-letter:nth-child(34) { animation-delay: 3.7s; }
        .wavy-letter:nth-child(34) { animation-delay: 3.8s; }
        .wavy-letter:nth-child(34) { animation-delay: 3.9s; }
        /* ===== CTA BUTTON ===== */
        .mm-cta {
          font-family: var(--font-body);
          font-weight: 600;
